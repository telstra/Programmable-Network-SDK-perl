...
#
package TelstraTPN::Configuration;
...
=head1 Name
        ...
        TelstraTPN::Configuration - holds the configuration for all TelstraTPN Modules
...
default: https://penapi.pacnetconnect.com
...
sub new {
	...
	# base_url
        $p{base_url} //= 'https://penapi.pacnetconnect.com';

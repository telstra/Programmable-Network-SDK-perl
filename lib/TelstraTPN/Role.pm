...
has _cfg => ( is => 'ro',
              isa => 'Str',
              default => 'TelstraTPN::Configuration',
              );

has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'Telstra Programmable Network API',
                          app_version => '2.1.3',
...
sub _build_af {
	...
	return TelstraTPN::ApiFactory->new(%args);
}
...
=head2 Telstra Programmable Network API version: 2.1.3
...
The tokens will be placed in the C<TelstraTPN::Configuration> namespace
as follows, but you don't need to know about this.

=over 4

=item C<$TelstraTPN::Configuration::username>

String. The username for basic auth.

=item C<$TelstraTPN::Configuration::password>

String. The password for basic auth.

=item C<$TelstraTPN::Configuration::api_key>
...
=item C<$TelstraTPN::Configuration::api_key_prefix>
...
=item C<$TelstraTPN::Configuration::access_token>
